...
/*!*************************!*\
  !*** ./actions/auth.js ***!
  \*************************/
/*! exports provided: signup, updateUser, signin, setCookie, removeCookie, getCookie, setLocalStorage, removeLocalStorage, authentication, signout, isAuth */
...
var ProfileUpdate = function ProfileUpdate() {
  ...
  var init = function init() {
    Object(_actions_user__WEBPACK_IMPORTED_MODULE_12__["getProfile"])(token).then(function (data) {
      if (data.error) {
  ...
  var handleChange = function handleChange(name) {
    return function (e) {
      ...
      (_console = console).log.apply(_console, Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__["default"])(userData)); // SEE THE FORMDATA IN CONSOLE


      setValues(_objectSpread({}, values, (_objectSpread2 = {}, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(_objectSpread2, name, value), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(_objectSpread2, "userData", userData), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(_objectSpread2, "error", false), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(_objectSpread2, "success", false), _objectSpread2)));
    };
  };
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    Object(_actions_user__WEBPACK_IMPORTED_MODULE_12__["update"])(token, userData).then(function (data) {
      if (data.error) {
        ...
        Object(_actions_auth__WEBPACK_IMPORTED_MODULE_11__["updateUser"])(data, function () {
          setValues(_objectSpread({}, values, {
            username: data.username,
            name: data.name,
            email: data.email,
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_8___default.a.Fragment, {
    ...
    src: "".concat(_config__WEBPACK_IMPORTED_MODULE_13__["API"], "/api/user/photo/").concat(username_for_photo),
...
//# sourceMappingURL=update.js.d1886ca485f225c6b160.hot-update.js.map