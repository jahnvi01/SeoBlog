...
var ProfileUpdate = function ProfileUpdate() {
  ...
  var init = function init() {
    Object(_actions_user__WEBPACK_IMPORTED_MODULE_11__["getProfile"])(token).then(function (data) {
      if (data.error) {
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    Object(_actions_user__WEBPACK_IMPORTED_MODULE_11__["update"])(token, userData).then(function (data) {
      if (data.error) {
        setValues(_objectSpread({}, values, {
          error: data.error,
          success: false,
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, {
    ...
    src: "".concat(_config__WEBPACK_IMPORTED_MODULE_12__["API"], "/api/user/photo/").concat(username),
...
//# sourceMappingURL=update.js.37e0b9cce011ea8f24d7.hot-update.js.map